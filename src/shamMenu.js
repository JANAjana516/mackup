...
export default function shamMenu(){
  ...
  const showPoducts = product.map((u,index) =>(
   ...
   <div key={index} className="menu_card">
    ...
    <div className="menu_image">
        <img src={"file:///C:/Users/Toshiba/Desktop/reactproject/back/example/storage/app"+u.imga}/>
    ...
    <div className="menu_info">
       ...
       <Link className="menu_btn" onClick={f(1)}>Order Now</Link>
    </div>
